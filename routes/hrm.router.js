...
router.route('/hr/complaints/read').get(catchErrors(complaintsController.readAll))
...
router.route('/hr/interviews/read').get(catchErrors(interviewsController.readAll))
...
router.route('/hr/payroll/read').get(catchErrors(payrollController.readAll))
